...
{
    /// <summary>
    /// Provides validation based on whether the date and time is after another date and time property within the entity.
    /// </summary>
    ...
    public class DateTimeAfterAttribute : ValidationAttribute
    {
        ...
        public DateTimeAfterAttribute(string otherProperty) : base("The {0} must be after the {1}.")
        {
